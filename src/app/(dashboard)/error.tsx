...
/**
 * Error boundary untuk area dashboard (tenant).
 * Menampilkan fallback di dalam layout dashboard (sidebar tetap terlihat).
 */
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] p-6 text-center">
      ...
      <p className="text-gray-500 text-sm mb-1 max-w-sm">
        Terjadi kesalahan saat memuat halaman ini. Data Anda aman — ini hanya masalah tampilan.
      </p>
